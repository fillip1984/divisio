...
const iconOptions = [
  ...
  { name: "Gamepad", value: "FaGamepad", icon: <FaGamepad /> },
  { name: "Dumbbell", value: "FaDumbbell", icon: <FaDumbbell /> },
  { name: "Person Running", value: "FaPersonRunning", icon: <FaRunning /> },
  { name: "Business Time", value: "FaBusinessTime", icon: <FaBusinessTime /> },
  { name: "Book", value: "FaBook", icon: <FaBook /> },
  { name: "Angel List", value: "FaAngellist", icon: <FaAngellist /> },
];
